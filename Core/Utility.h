...
namespace std {
    ...
    struct hash<D3D12_SHADER_RESOURCE_VIEW_DESC> {
        size_t operator()(const D3D12_SHADER_RESOURCE_VIEW_DESC& srvDesc) const noexcept {
            size_t seed = 0;
    ...
    struct hash<D3D12_UNORDERED_ACCESS_VIEW_DESC> {
        size_t operator()(const D3D12_UNORDERED_ACCESS_VIEW_DESC& uavDesc) const noexcept {
            size_t seed = 0;
